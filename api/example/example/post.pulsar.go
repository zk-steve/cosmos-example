...
func init() {
	...
	md_Post = File_example_example_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_example_example_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "example.example.Post.title":
		return x.Title != ""
	case "example.example.Post.body":
		return x.Body != ""
	case "example.example.Post.creator":
		return x.Creator != ""
	case "example.example.Post.id":
		return x.Id != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: example.example.Post"))
		}
		panic(fmt.Errorf("message example.example.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message example.example.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "example.example.Post.title":
		panic(fmt.Errorf("field title of message example.example.Post is not mutable"))
	case "example.example.Post.body":
		panic(fmt.Errorf("field body of message example.example.Post is not mutable"))
	case "example.example.Post.creator":
		panic(fmt.Errorf("field creator of message example.example.Post is not mutable"))
	case "example.example.Post.id":
		panic(fmt.Errorf("field id of message example.example.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: example.example.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in example.example.Post", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: example/example/post.proto
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_example_example_post_proto_rawDescGZIP(), []int{0}
}
...
var File_example_example_post_proto protoreflect.FileDescriptor

var file_example_example_post_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
	0x65, 0x2f, 0x70, 0x6f, 0x73, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x65, 0x78,
	0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x22, 0x5a, 0x0a,
	...
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x42, 0x9f, 0x01, 0x0a, 0x13, 0x63, 0x6f,
	0x6d, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
	0x65, 0x42, 0x09, 0x50, 0x6f, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x20,
...
var (
	file_example_example_post_proto_rawDescOnce sync.Once
	file_example_example_post_proto_rawDescData = file_example_example_post_proto_rawDesc
)

func file_example_example_post_proto_rawDescGZIP() []byte {
	file_example_example_post_proto_rawDescOnce.Do(func() {
		file_example_example_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_example_example_post_proto_rawDescData)
	})
	return file_example_example_post_proto_rawDescData
}

var file_example_example_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_example_example_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: example.example.Post
}
var file_example_example_post_proto_depIdxs = []int32{
...
func init() { file_example_example_post_proto_init() }
func file_example_example_post_proto_init() {
	if File_example_example_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_example_example_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_example_example_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_example_example_post_proto_goTypes,
		DependencyIndexes: file_example_example_post_proto_depIdxs,
		MessageInfos:      file_example_example_post_proto_msgTypes,
	}.Build()
	File_example_example_post_proto = out.File
	file_example_example_post_proto_rawDesc = nil
	file_example_example_post_proto_goTypes = nil
	file_example_example_post_proto_depIdxs = nil
}
